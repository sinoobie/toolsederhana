...
def head():
		...
		print(bld+lr+"     ================",y+"By: KANG NEWBIE",lr+"=============="+x)
		print("\n")
...
def menu():
		...
		#proses input
				...
				print("Btw Terimakasih banyak kepada Allah SWT,\nsemua member AICA, BlackHole Scurity, CRABS, PythonID dan terutama orang yang scriptnya gua recode  :*")
				print(lr+"++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n"+x)
		...
		#proses input
				...
				print("Saya Masih Newbie dan suka men-recode script orang h3h3h3.")
				print(lr+"+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n"+x)
				go_back=input(s+y+"klik 0 buat balik ke menu. > ")
				while go_back !="0":
						print (s+lr+"Masukin 0 aja gabisa ! >:(")
